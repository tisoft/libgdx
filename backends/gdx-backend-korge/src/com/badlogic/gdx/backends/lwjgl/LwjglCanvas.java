...
public class LwjglCanvas implements Application {
	...
	private void initialize (ApplicationListener listener, LwjglApplicationConfiguration config) {
		...
		if (!LwjglApplicationConfiguration.disableAudio) audio = new OpenALLwjglAudio();
...
//					Display.sync(getFrameRate());
	...
	protected int getFrameRate () {
		int frameRate = graphics.config.foregroundFPS;//Display.isActive() ? graphics.config.foregroundFPS : graphics.config.backgroundFPS;
