...
//		initiateGL(gl);
	...
	private void extractVersion () {
		String versionString = gl.getString(gl.getVERSION());
		String vendorString = gl.getString(gl.getVENDOR());
		String rendererString = gl.getString(gl.getRENDERER());
		glVersion = new GLVersion(Application.ApplicationType.Desktop, versionString, vendorString, rendererString);
	}

	private void extractExtensions () {
		extensions = new Array<String>();
		extensions.addAll(gl.getString(GL20.GL_EXTENSIONS).split(" "));
	}
...
//		}
	...
	public void initiateGLInstances () {
		...
		if (!supportsFBO()) {
			throw new GdxRuntimeException("OpenGL 2.0 or higher with the FBO extension is required. OpenGL version: "
				+ gl20.glGetString(gl20.GL_VERSION) + ", FBO extension: false\n" + glVersion.getDebugVersionString());
		}
